...
import { ADD_COMMENT, REMOVE_COMMENT, EDIT_COMMENT, VOTE_UP_COMMENT, VOTE_DOWN_COMMENT } from "../actions/commentAction";
 ...
 export const commentsReducer = (state = [], action) => {
  switch (action.type) {
    ...
    case EDIT_COMMENT:
      return {
        ...state,
        comments: state.comments.map(comment => comment.id === action.payload.id ? {...comment, text: action.payload.text}
          : comment
        )
      };
